    ...
    <div class="full-page login-page" filter-color="black" data-image="{{asset('assets/img/login.jpg')}}">
        ...
        <div class="content">
            <div class="container">
                ...
                @if (session('status'))
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <p class="alert alert-success">Um novo link de verificação foi enviado para o endereço de e-mail fornecido durante o registro.</p>
                    </div>
                @endif

                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <p class="alert alert-success">Obrigado por inscrever-se! Antes de começar, você poderia verificar seu endereço de e-mail clicando no link que acabamos de enviar para você? Se você não recebeu o e-mail, teremos o prazer de enviar outro.</p>
                    </div>
                        ...
                        <form method="post" action="{{route('verification.send')}}">
                            ...
                            <div class="card card-login card-hidden">
                                <div class="card-header text-center" data-background-color="purple">
                                    <h4 class="card-title">Verificar E-mail</h4>
                                </div>
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-primary" formnovalidate formaction="{{route('user.logout')}}">Sair</button>
                                </div>
                            </div>
                        </form>
                    </div>
